...
/// <summary>Azure Function REST Bridge — Reusable Azure Function REST Bridge engineering pattern.</summary>
public sealed class AzureFunctionRestBridgeClient
{
    private readonly HttpClient _client;
    public AzureFunctionRestBridgeClient(HttpClient client) => _client = client;
