...
/// <summary>Azure Key Vault Secret Boundary — Reusable Azure Key Vault Secret Boundary engineering pattern.</summary>
public sealed class AzureKeyVaultSecretBoundaryClient
{
    private readonly HttpClient _client;
    public AzureKeyVaultSecretBoundaryClient(HttpClient client) => _client = client;
