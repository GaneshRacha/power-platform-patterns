...
/// <summary>Integration Correlation & Observability Pattern — Reusable Integration Correlation & Observability Pattern engineering pattern.</summary>
public sealed class IntegrationCorrelationObservabilityClient
{
    private readonly HttpClient _client;
    public IntegrationCorrelationObservabilityClient(HttpClient client) => _client = client;
