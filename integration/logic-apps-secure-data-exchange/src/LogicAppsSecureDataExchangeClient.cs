...
/// <summary>Logic Apps Secure Data Exchange — Reusable Logic Apps Secure Data Exchange engineering pattern.</summary>
public sealed class LogicAppsSecureDataExchangeClient
{
    private readonly HttpClient _client;
    public LogicAppsSecureDataExchangeClient(HttpClient client) => _client = client;
