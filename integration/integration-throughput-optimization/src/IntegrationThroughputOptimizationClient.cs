...
/// <summary>Integration Throughput Optimization Pattern — Reusable Integration Throughput Optimization Pattern engineering pattern.</summary>
public sealed class IntegrationThroughputOptimizationClient
{
    private readonly HttpClient _client;
    public IntegrationThroughputOptimizationClient(HttpClient client) => _client = client;
