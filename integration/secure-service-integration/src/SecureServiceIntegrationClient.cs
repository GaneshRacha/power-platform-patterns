...
/// <summary>Secure Service Integration Framework — Reusable Secure Service Integration Framework engineering pattern.</summary>
public sealed class SecureServiceIntegrationClient
{
    private readonly HttpClient _client;
    public SecureServiceIntegrationClient(HttpClient client) => _client = client;
