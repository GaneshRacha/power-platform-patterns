...
/// <summary>HTTPS & Endpoint Allowlist Validation — Reusable HTTPS & Endpoint Allowlist Validation engineering pattern.</summary>
public sealed class HttpsEndpointAllowlistValidationClient
{
    private readonly HttpClient _client;
    public HttpsEndpointAllowlistValidationClient(HttpClient client) => _client = client;
