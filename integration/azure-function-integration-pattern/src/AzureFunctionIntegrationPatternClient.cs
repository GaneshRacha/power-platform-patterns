...
/// <summary>Azure Function Integration Pattern — Reusable Azure Function Integration Pattern engineering pattern.</summary>
public sealed class AzureFunctionIntegrationPatternClient
{
    private readonly HttpClient _client;
    public AzureFunctionIntegrationPatternClient(HttpClient client) => _client = client;
